...
def run(seed):
    ...
    for step in range(150):
        ...
        rewards = compute_reward(x_train, y_train, x_test, y_test, actions, num_iter=500, lr=1e-2, batch_size=64, dictionary=dictionary)
...
if __name__ == '__main__':   
    ...
    np.save('./results/m100_n24_linear_correlation0.5_coef1_threshold0.95_actor_step150_1e-3_regressor_step500_lr1e-2_2.5hour_last10', dats)